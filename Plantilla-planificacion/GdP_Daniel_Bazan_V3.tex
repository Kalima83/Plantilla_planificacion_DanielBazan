  ...
  \item \textbf{Épica 1 - Optimizar el proceso de carga de datos.}
    \begin{itemize}
      \item HU1 - ``\textit{Como jefe de las líneas de mantenimiento, quiero que la carga de datos de las solicitudes incluya al menos 5 campos obligatorios (identificación del usuario, descripción de equipo, ubicación, Tipo de falla, pruebas realizadas ) para que el especialista comprenda el problema con un 90\% de precisión en la primera revisión}''
		...
		\end{itemize}     
      \item HU2 - "\textit{Como usuario, quiero contar con una guía específica y sencilla para solicitar el mantenimiento de equipos electrónicos y reducior así errores en la carga}"
      	\begin{itemize}
			\item Dificultad: 3
			\item Complejidad: 5
