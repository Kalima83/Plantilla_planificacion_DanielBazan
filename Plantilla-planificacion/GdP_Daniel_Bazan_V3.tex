...
\end{itemize}
Estudios recientes como \textit{B. Zhang, et al. (2025) — Maintenance Decision-Making Using Intelligent Machine Learning for Spare Parts, S. Tapia, et al. (2024) — Mantenimiento predictivo basado en machine learning: una revisión sistemática} y \textit{M. İfraz, et al. (2025) — A Systematic Literature Review on Spare Parts Inventory Management} confirman la madurez de los modelos de \textit{Machine Learning} para anticipar fallas y vincular predicciones con planes de inventario.
...
\begin{itemize}
	...
	\item Auspiciante: en su interés de mejorar el proceso compra de los repuestos e insumos a fin de tener un mantenimiento más eficiente. Ellos costean tanto mi especialización como los gastos del proyecto.  
	\item Equipo: son 13 técnicos  electrónicos que se dedican a la reparación de los equipos del EA y están bajo mi cargo.
\end{itemize}
...
para optimizar el proceso de consulta y asegurar que los especialistas dediquen su tiempo únicamente a tareas que requieran análisis técnico avanzado, logrando una eficiencia del 70\% en las respuestas del chatbot.}" 
      	\begin{itemize}
			\item Dificultad: 6
			\item Complejidad: 8
...
Sprint 10 & Escritura & Redacción memoria & 45 h / 34 SP & Alumno & 0\% \\ \hline
...
\begin{figure}[h!]
    \centering
\includegraphics[width=0.95\textwidth]{./Figuras/GdP_BAZAN_gan_page3.png}
...
\begin{figure}[h!]
    \centering
\includegraphics[width=0.95\textwidth]{./Figuras/GdP_BAZAN_gan_page1.png}
\includegraphics[width=0.95\textwidth]{./Figuras/GdP_BAZAN_gan_page2.png}
